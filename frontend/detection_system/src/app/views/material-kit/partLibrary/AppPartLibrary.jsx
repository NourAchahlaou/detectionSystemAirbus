...
const stopCamera = async () => {
  try {
    ...
    const data = await response.json();
    console.log(data.message || "Camera stopped successfully");
...
//       {isCameraStarted && capturedImagesCount > 0 && (
//         <div style={{ marginTop: "20px", display: "flex", flexDirection: "column", alignItems: "center" }}>
//           <Typography variant="h6">Captured Images ({capturedImagesCount}/{requiredCaptures})</Typography>
